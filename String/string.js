...
//string templates / tamplets strings /template litarels/back -tics syntax --

 // tamplets litarels এ quote ('') ব্যবহার না করে back-ticks (``) চিহ্ন ব্যবহার করা হয়।  
 
  let a = 'sayntax'; // with quote
  document.write(a + '<br>');

  let b = `saytax`;  // with back-ticks
  document.write(b + '<br>');
 
  //single quote এর মধ্যে single quote যায় না  double quore দিতে হয় ।  আবার double qoute এর মধ্যে double qoute দেওয়া যায় না  single quote দিতে হয় । এই সমসা সমাধানের জন্য back-tics ব্যবহার করা হয় । back-tics  এর মধ্যে single qoute ও double quote যা খুশি তাই দেওয়া যায়। 
  let back = `it's 'my' "life", and "i a'm" "the " 'wonner' `;
  document.write(back+ '<br>'); // into back-ticks any qoute van be used ..

  // single বা double quote দ্বারা multiline string লেখা যায় না। কিন্তু back-ticks ব্যবহার করে multiline ব্যবহার করা যায়। 
  let multiline = `this is back ticks - quote.
  in vack-ticks we cam use multile .
  like this.. `;
  console.log(multiline);  // console ভাল দেখা যায় পেজে দেখা যায় না। 


   // interpolation / variables substitutions --

// interpolation এর মধ্যে কোন expression গুলো লেখা যায় । doller চিহ্ন (&) ও তৃতীয় বন্ধনির {} মধ্যে interpolation এর expression গুলো লেখা হয়। হ 

let country = 'Bangladesh';
let population = '160 Million';
let continent = 'Asia';
let Country_details = `i live in ${country} and it's population ${population}. it is in ${continent} continent . ` 
document.write(Country_details + '<br>');


const sum__1 = 744;
const sum__2 = 954.12;
const total = `How Much monet you have ? $${sum__1 + sum__2} ? `
