...
var ab = a >= b ;
document.write ( "a >= b => "+ ab +"<br>");
//its printing true because here on value true and one value wrong.
...
// 2 assignment means its only chack value. here one variable is integer and one is string. dispite of deffarent variable its printed true 'cause dobul assign check only value not data type..
...
// && operator তখনি true result প্রকাশ করবে যখন সকল value true হবে। যদি একটি value true এবং একটি value false হয় তাহলে result দেখাবে false । অর্থাৎ প্রতিতা value true হলেই result true দেখাবে । একটি false হলেই সব false দেখাবে। 
