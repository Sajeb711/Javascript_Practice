...
// যখন অনেকগুলো condition থাকে তখন else if ব্যবহার করা হয়। অর্থাৎ আমার যদি তিনটা statement থাকে তখন if দিয়ে একটি statement লিখব else দিয়ে শেষের statement লিখব । তাহলে বাকি একটা statement লিখার জন্য else if ব্যবহার করা হয়।
